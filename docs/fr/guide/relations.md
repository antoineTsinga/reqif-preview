...
l'événement `unresolved-reference` est émis ([diagnostics](/fr/guide/diagnostics)).
...
dans [Onglets, numérotation, lecture](/fr/guide/mise-en-page#un-routeur-spa-qui-intercepte-les-liens-casse-les-onglets).
:::
...
directement via le [modèle de données](/fr/guide/rendu-maison) si vous en avez besoin.
